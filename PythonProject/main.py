...
def main(n, t, m):
    ...
    """Go Through Collisions and check if they are already inside a code when they occur"""
    ...
    """Connecting of the final collision lines, depending on their cones (3 cones always have 3 collisions together)"""
